...
function deposit(credit, sequelize, config, callback) {
  ...
  var coinbaseSql = 'Insert into Deposit values ( :source, :amount, :currency, :wallet );';
  var ledgerSql = 'Insert into Ledger values ( :source, :amount, :currency, :wallet );';

  sequelize.query(coinbaseSql,  { replacements: { wallet: config.wallet, source: credit["https://w3id.org/cc#source"], amount: credit["https://w3id.org/cc#amount"], currency: credit["https://w3id.org/cc#currency"] } }).then(function(res) {
    return sequelize.query(ledgerSql,  { replacements: { wallet: config.wallet, source: credit["https://w3id.org/cc#source"], amount: credit["https://w3id.org/cc#amount"], currency: credit["https://w3id.org/cc#currency"] } })
  }).then(function(){
